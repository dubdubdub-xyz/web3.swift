...
let package = Package(
    ...
    dependencies: [
        .package(name: "BigInt", url: "https://github.com/attaswift/BigInt", .upToNextMinor(from: "5.3.0")),
        ...
        .target(
            ...
            dependencies:
                [
                    ...
                    .target(name: "BigInt", package: "BigInt"),
                    .target(name: "GenericJSON", package: "GenericJSON"),
